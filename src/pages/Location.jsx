...
const Location = ({ soldiers = [], activeSquadId = 1 }) => {
        ...
        <div className="p-6 flex-1 overflow-y-auto custom-scrollbar">
          ...
          <div className="space-y-3">
            {activeSquadUnits.map((unit) => (
              <div 
                key={unit.id}
                className={`p-4 rounded-lg border transition-all hover:border-blue-500/50 bg-[#151a29] ${
                  unit.status === 'CRITICAL' ? 'border-red-500/50 bg-red-500/5' : 'border-slate-800'
                }`}
              >
               ...
               return (
                ...
                >
                  <div className="relative group cursor-pointer">
                    ...
                    <div className={`size-8 rounded-full border-2 border-white flex items-center justify-center text-white shadow-2xl relative z-10 transition-colors ${
                      unit.status === 'CRITICAL' ? 'bg-red-600' : 'bg-blue-600'
                    }`}>
